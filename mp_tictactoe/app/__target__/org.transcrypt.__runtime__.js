// Transcrypt'ed from Python, 2021-10-26 22:27:12
...
export var Exception =  __class__ ('Exception', [BaseException], {
	...
	get __repr__ () {return __get__ (this, function (self) {
		if (len (self.__args__) > ) {
			...
			return .format (self.__class__.__name__, repr (self.__args__ []));
		}
		else {
...
export var __Terminal__ =  __class__ ('__Terminal__', [object], {
	...
	get __init__ () {return __get__ (this, function (self) {
		self.buffer = ;
		try {
			self.element = document.getElementById ();
		}
		catch (__except0__) {
			self.element = ;
		}
		if (self.element) {
			self.element.style.overflowX = ;
			self.element.style.boxSizing = ;
			self.element.style.padding = ;
	...
	get print () {return __get__ (this, function (self) {
		...
		self.buffer = .format (self.buffer, sep.join ((function () {
			...
			return __accu0__;
		}) ()), end).__getslice__ (-(), null, 1);
		if (self.element) {
			self.element.innerHTML = self.buffer.py_replace (, ).py_replace (, );
	...
	get input () {return __get__ (this, function (self, question) {
		...
		var answer = window.prompt (.join (self.buffer.py_split ().__getslice__ (-(), null, 1)));
		self.print (answer);
		return answer;
	});}
});
